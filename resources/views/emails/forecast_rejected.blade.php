                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 30px; color: #4a5568; font-size: 15px; line-height: 1.6;">
                                Tu solicitud de cambio de objetivo de ventas (forecast) ha sido <strong style="color: #e53e3e;">rechazada</strong> por <strong>{{ $rejectorName }}</strong>.
                            </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <p style="margin: 8px 0 0; color: #e53e3e; font-size: 20px; font-weight: 700;">${{ number_format((float) $proposedAmount, 2) }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
