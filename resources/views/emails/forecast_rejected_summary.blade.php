...
<head>
    ...
    <title>Forecast rechazado</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 30px; color: #4a5568; font-size: 15px; line-height: 1.6;">
                                <strong>{{ $rejectorName }}</strong> rechazó
                                {{ count($changes) === 1 ? 'tu solicitud de cambio' : 'tus ' . count($changes) . ' solicitudes de cambio' }}
                                de objetivo de ventas (forecast) para este cliente. El objetivo actual se mantiene sin cambios.
                            </p>
                            ...
                            <p style="margin: 0 0 12px; color: #718096; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">
                                Detalle de los meses rechazados
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                @foreach ($changes as $change)
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" style="padding: 12px; border-bottom: 1px solid #edf2f7; color: #c53030; font-size: 15px; font-weight: 700;">${{ number_format($proposed, 2) }}</td>
