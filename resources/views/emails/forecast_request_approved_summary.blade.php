                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 20px; color: #2d3748; font-size: 16px; line-height: 1.6;">
                                <strong>Hola, {{ $submitterName }}</strong>
                            </p>

                            <p style="margin: 0 0 30px; color: #4a5568; font-size: 15px; line-height: 1.6;">
                                <strong>{{ $approverName }}</strong> aprobó
                                {{ count($changes) === 1 ? 'tu solicitud de cambio' : 'tus ' . count($changes) . ' solicitudes de cambio' }}
                                de objetivo de ventas (forecast) para este cliente. Los nuevos objetivos ya
                                {{ count($changes) === 1 ? 'quedó aplicado' : 'quedaron aplicados' }} en el forecast.
                            </p>
                            ...
                            <p style="margin: 0 0 12px; color: #718096; font-size: 13px; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">
                                Detalle de los meses aprobados
                            </p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="background-color: #f7fafc;">
                                    ...
                                    <th align="right" style="padding: 10px 12px; border-bottom: 1px solid #e2e8f0; color: #718096; font-size: 12px; text-transform: uppercase; letter-spacing: 0.5px;">Monto aprobado</th>
                            ...
                            @include('emails.partials.forecast_year_table', ['overviewCaption' => 'los meses resaltados son los que se aprobaron', 'changedBadge' => 'Aprobado'])
                            ...
                            <p style="margin: 0; color: #4a5568; font-size: 14px; line-height: 1.6;">
                                Ingresa a la plataforma para consultar el forecast actualizado:
